                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                @include('components.form.input', [
                                    ...
                                    'field_name' => 'employee',
                                    'label' => 'Employee',
                                    'value' => old('employee', $row->employee->name ?? null),
                                ...
                                @include('components.form.input', [
                                    ...
                                    'field_name' => 'alias',
                                    'label' => 'Alias',
                                    'value' => old('alias', $row->employee->alias ?? null),
                                    'placeholder' => 'Alias',
                                    'show' => true,
                                    'disabled' => true,
                                ])
                                ...
                                @include('components.form.input', [
                                    ...
                                    'value' => old(
                                        'gender',
                                        isset($row->employee->gender) && $row->employee->gender == 'L' ? 'Laki-laki' : 'Perempuan'),
                                    'placeholder' => 'Gender',
                                    'show' => true,
                                    'disabled' => true,
                                ])
                                ...
                                @include('components.form.input', [
                                    ...
                                    'field_name' => 'Phone',
                                    'label' => 'phone',
                                    'value' => old('phone', $row->employee->phone ?? null),
                                    'placeholder' => 'phone',
                                    'show' => true,
                                    'disabled' => true,
                                ])
                            ...
                            <div class="col-4">
                                @include('components.form.input', [
                                    ...
                                    'field_name' => 'nip',
                                    'label' => 'NIP',
                                    'value' => old('nip', $row->employee->nip ?? null),
                                    'placeholder' => 'nip',
                                    'show' => true,
                                    'disabled' => true,
                                ])
                                ...
                                @include('components.form.input', [
                                    ...
                                    'value' => old('tempat', $row->employee->tempat ?? null),
                                ...
                                @include('components.form.input', [
                                    ...
                                    'field_name' => 'dob',
                                    'label' => 'Date Of Birth',
                                    'value' => old('dob', $row->employee->tempat ?? null),
                                ...
                                @include('components.form.input', [
                                    ...
                                    'field_name' => 'Point',
                                    'label' => 'point',
                                    'value' => old('point', $row->employee->tempat ?? null),
                                    'placeholder' => 'Point',
                                    'show' => true,
                                    'disabled' => true,
                                ])
